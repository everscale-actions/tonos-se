...
const releaseUrl = `https://github.com/${global.githubBinariesRepository}/releases/download/${global.nodeSeReleaseTag}/release-${getOsByPlatform()}.tar.gz`;
const sha1Url = `https://github.com/${global.githubBinariesRepository}/releases/download/${global.nodeSeReleaseTag}/release-${getOsByPlatform()}.tar.gz.sha256`;
