...
global.nodeSeRequestsPort = process.env.TONOS_SE_NODESE_KAFKA_MSG_PORT ?? config['ton-node-kafka-msg-port'];
global.nodeSeAdnlPort = process.env.TONOS_SE_NODESE_ADNL_PORT ?? config['ton-node-adnl-port'];
