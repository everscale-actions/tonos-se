...
async function isRemotHashChanged(releaseFilePath, hashDownloadUrl) {
...
async function install() {
  // get binaries release info from github and compose urls to download arhive and hash files
  ...
  const remoteHashChanged = await isRemotHashChanged(releaseFilePath, downloadUrls.hash);
  ...
  // return info about used binaries release and avalible tonos se versions in assets
  return {
    binariesRelease,
