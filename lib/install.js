...
async function isLocalAndRemoteHashesDifferent(releaseFilePath, hashDownloadUrl) {
...
async function install() {
  ...
  if (await isLocalAndRemoteHashesDifferent(releaseFilePath, downloadUrls.hash)) {
  ...
  if (fs.existsSync(global.appsPath)
    ...
    process.stdout.write('New binary package detected! Applying updates..\n');
    await stop();
