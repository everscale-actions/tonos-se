...
async function start() {
    if (!fs.existsSync(moduleConfig.pidFilePath)) {
        ...
        await serverManagement.runService(moduleConfig.binPath, moduleConfig.paramsStart, moduleConfig.workingDir)
    } else {
...
async function stop() {
    if (fs.existsSync(moduleConfig.pidFilePath)) {
        ...
        await serverManagement.runService(moduleConfig.binPath, moduleConfig.paramsStop, moduleConfig.workingDir)
    } else {
